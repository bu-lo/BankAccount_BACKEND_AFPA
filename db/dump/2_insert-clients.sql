...
INSERT INTO public."client" (first_name, last_name, birth_date, id, email)
SELECT first_name, last_name, to_date(birth_date, 'YYYY-MM-DD'), gen_random_uuid(), email FROM (
    VALUES
...
) AS clients (first_name, last_name, birth_date, email);
